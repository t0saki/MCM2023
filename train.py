...
for epoch in range(num_epochs):
    ...
    if epoch % 50 == 0:
        torch.save(model.state_dict(), "/mnt/d/checkpoints/"+"wordle"+"_"+str(epoch)+"epochs"+train_loss_str)

# Save model
torch.save(model.state_dict(), "checkpoints/"+"wordle"+"_"+str(num_epochs)+"final"+train_loss_str)